...
public partial class BangumiApi
{
    ...
    {
        return await SendRequest<User>("https://n.kono-dio.top/bgmtv/v0/me", accessToken, token);
    }
    ...
    {
        return await SendRequest<DataList<EpisodeCollectionInfo>>($"https://n.kono-dio.top/bgmtv/v0/users/-/collections/{subjectId}/episodes?episode_type={episodeType}", accessToken, token);
    }
    ...
    public async Task UpdateCollectionStatus(string accessToken, int subjectId, CollectionType type, CancellationToken token)
    {
        ...
        {
            Url = $"https://n.kono-dio.top/bgmtv/v0/users/-/collections/{subjectId}",
...
#else
        var request = new HttpRequestMessage(HttpMethod.Post, $"https://n.kono-dio.top/bgmtv/v0/users/-/collections/{subjectId}");
    ...
    {
        return await SendRequest<EpisodeCollectionInfo>($"https://n.kono-dio.top/bgmtv/v0/users/-/collections/-/episodes/{episodeId}", accessToken, token);
    }
    ...
    public async Task UpdateEpisodeStatus(string accessToken, int subjectId, int episodeId, EpisodeCollectionType status, CancellationToken token)
    {
        ...
        var options = new HttpRequestOptions
        {
            Url = $"https://n.kono-dio.top/bgmtv/v0/users/-/collections/-/episodes/{episodeId}",
...
#else
        var request = new HttpRequestMessage(HttpMethod.Put, $"https://n.kono-dio.top/bgmtv/v0/users/-/collections/-/episodes/{episodeId}");
